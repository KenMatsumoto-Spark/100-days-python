...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        with open('static/cafe-data.csv', newline='', encoding='UTF-8') as csv_file:
            csv_data = csv.reader(csv_file, delimiter=',')
            list_of_rows = []
            for row in csv_data:
                list_of_rows.append(row)
            list_of_rows.append(new_entry)
        with open('static/cafe-data.csv', mode="w", newline='', encoding='UTF-8') as csv_file:
